...
//        edgeDetector.setLowThreshold(0.8f);
        edgeDetector.setLowThreshold(0.4f);
//        edgeDetector.setHighThreshold(2.5f);
        edgeDetector.setHighThreshold(1.0f);
    ...
    public int[][] findCircles() {
        ...
        int[][] results = new int[maximumNumberOfCircles][4];
        ...
        for (int maxCircles = 0; maxCircles < maximumNumberOfCircles; maxCircles++) {
            ...
            System.arraycopy(circle, 0, results[maxCircles], 0, 4);
